# Top-Category-Menu-Clickable-
Top Category Menu Clickable -opentcart V 3.0.3.7
...
<modification>
	...
	<file path="catalog/view/theme/*/template/common/menu.twig">
		<operation>
			...
			<li class="dropdown"><a href="{{ category.href }}" class="dropdown-toggle{{ disabled }}" data-toggle="dropdown">{{ category.name }}</a>
			]]></add>
        </operation>
	</file>
</modification>
